...
A project template for creating new Kratos services with gRPC
transports, protobuf-first APIs, Wire dependency injection,
...
internal/server/      gRPC server construction
...
Default local port is configured in `configs/config.yaml`:
